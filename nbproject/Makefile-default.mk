...
FINAL_IMAGE=${DISTDIR}/TumbleTimer.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/TumbleTimer.${IMAGE_TYPE}.${OUTPUT_SUFFIX}



sourceline.device=sourceline="\#device PIC18F2455"
...
ifeq (2,1) 
	...
	@mv ${OBJECTDIR}/main.cof "${DISTDIR}/TumbleTimer.${IMAGE_TYPE}.cof" 
	@mv ${OBJECTDIR}/main.hex "${DISTDIR}/TumbleTimer.${IMAGE_TYPE}.hex"
else 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/TumbleTimer.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	${MKDIR} ${DISTDIR} 
ifeq (2,1) 
	
else 
	${MP_LD}   out="${DISTDIR}"  +FH +EX +DF +CC LINK=TumbleTimer.${IMAGE_TYPE}.hex=${OBJECTDIR}/main.o +Y=9 +EA +DF +LN +T +A +M +J +Z -P
